...
echo -e "ID: 27\\nZeit: $STAMP\\nBeschreibung: Fontsize-Button-Fix, zwei Buttons (A+/A–), robust\\nDateien:\\n  - $GUIFILE" > creatoros/updater/meta/changes/change_27.txt
echo "Update 27 applied $STAMP" >> creatoros/updater/info-stand.txt
md5sum "$GUIFILE" >> creatoros/updater/CHECKSUMS.txt

echo "✅ Update 27 erfolgreich abgeschlossen."
